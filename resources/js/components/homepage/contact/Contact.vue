            ...
            <div class="col-md-8">
                <v-row>
                    <v-form>
                        ...
                        <v-text-field outlined label="Email" dense></v-text-field>
                        <v-text-field outlined label="Subject" dense></v-text-field>
                        <v-textarea outlined name="input-7-4" label="Message"></v-textarea>
